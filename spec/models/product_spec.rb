...
RSpec.describe Product, type: :model do
  ...
  #TODO Fix numericality validation after update
  ...
  describe ".filter_by_title" do
    before(:each) do
      ...
      @product4 = FactoryGirl.create :product, title: "LDC TV"
    end
  ...
  describe ".search" do
    ...
    context "when title is 'videogame' and '100' a min price are set" do
